...
export default function Body() {
  ...
  const[resObject ,setResObj]= useState(resObj)
  const handleClick=()=>{
    const rest=resObject.filter((res)=>res.data.avgRating > 4)
    setResObj(rest);
  }
  return (
    <div>
      ...
      <div className="btn" onClick={handleClick}>Button</div>
      <div className="res-container">
        {resObject.map((restaurant, index) => (
